...
export default {
  ...
  routes: [
    ...
    },
    {
      ...
      method: "POST",
      handler: "pauseSubscriptionCommand",
    ...
    },
    {
      ...
      method: "POST",
      handler: "resumeSubscriptionCommand",
    ...
    },
    {
      ...
      method: "POST",
      handler: "renewSubscriptionCommand",
    ...
    {
      path: "/api/sales/returns/receive",
      method: "POST",
      handler: "receiveReturnOrderCommand",
      description: "Receive approved return orders",
      roles: ["admin", "sales_manager", "sales_ops"],
    },
    {
      path: "/api/sales/returns/inspect",
      method: "POST",
      handler: "inspectReturnOrderCommand",
      description: "Inspect received return orders",
      roles: ["admin", "sales_manager", "sales_ops"],
    },
    {
      path: "/api/sales/returns/credit-note",
      method: "POST",
      handler: "generateReturnCreditNoteCommand",
      description: "Generate return credit notes from inspected returns",
      roles: ["admin", "sales_manager", "sales_ops"],
    },
    {

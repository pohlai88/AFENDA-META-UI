/**
 * Resolution Cache — LRU cache with dependency tracking for metadata resolution.
 * Extracted from @afenda/meta-types (Phase 2).
 */

import type { CacheEntry, CacheStats, ResolutionCacheConfig } from "@afenda/meta-types/platform";

        ...
        <CardHeader>
          <div className="flex justify-center mb-4">
            <div className="p-4 bg-destructive/10 rounded-full">
              <Wrench className="w-12 h-12 text-destructive" aria-hidden="true" />
            </div>
          </div>
          <CardTitle className="text-4xl">503</CardTitle>
          <CardDescription className="text-lg">Service Unavailable</CardDescription>
        </CardHeader>

...
describe("safeLazy", () => {
  describe("Successful Loading", () => {
    ...
    it("loads module with named export", async () => {
      ...
      const LazyComponent = safeLazy(
        async () => ({ TestComponent }),
        { exportName: "TestComponent", rendererId: "test" }
      );
  ...
  describe("Failure Handling", () => {
    ...
    it("shows fallback when named export missing", async () => {
      const LazyComponent = safeLazy(
        async () => ({ SomeOtherExport: () => <div>Wrong</div> }),
        { exportName: "TestComponent", rendererId: "test-missing" }
      );
    ...
    it("shows fallback when default export missing", async () => {
      const LazyComponent = safeLazy(
        async () => ({ namedExport: () => <div>Named</div> }),
    ...
    it("shows fallback when export is not a function", async () => {
      const LazyComponent = safeLazy(
        async () => ({ default: "not a function" as any }),
  ...
  describe("Fallback UI", () => {
    ...
    it("displays export name in fallback", async () => {
      const LazyComponent = safeLazy(
        async () => ({}),
        { exportName: "MyComponent", rendererId: "test" }
      );
  ...
  describe("Custom Fallback", () => {
    it("uses custom fallback component when provided", async () => {
      ...
      const LazyComponent = safeLazy(
        async () => null as any,
        { fallback: CustomFallback, rendererId: "test" }
      );

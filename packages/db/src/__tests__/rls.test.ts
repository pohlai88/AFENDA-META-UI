...
import { clearSessionContext, setSessionContext } from "../_session/index.js";
import {
  appUserRole,
  serviceRole,
...
describe("RLS tenant isolation helpers", () => {
  ...
  it.skipIf(!process.env.DATABASE_URL)("sets and clears session context inside a transaction", async () => {

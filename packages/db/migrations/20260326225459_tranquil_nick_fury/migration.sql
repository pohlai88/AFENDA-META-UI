...
CREATE TYPE "sales"."domain_event_type" AS ENUM('REPORT_VALIDATED', 'REPORT_CONFIRMED', 'INVOICE_GENERATED', 'AGREEMENT_EXPIRED', 'AGREEMENT_ACTIVATED');--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_reference_banks_name_country" ON "reference"."banks" (lower("name"),"country_id") WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_reference_countries_name" ON "reference"."countries" ("name");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_countries_code" ON "reference"."countries" (lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_reference_currencies_active" ON "reference"."currencies" ("is_active","code");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_currencies_code" ON "reference"."currencies" (upper("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_reference_sequences_tenant_code" ON "reference"."sequences" ("tenant_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_reference_states_country" ON "reference"."states" ("country_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_states_country_code" ON "reference"."states" ("country_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_reference_uoms_category" ON "reference"."units_of_measure" ("category_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_uoms_category_name" ON "reference"."units_of_measure" ("category_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_uoms_reference_per_category" ON "reference"."units_of_measure" ("category_id") WHERE "deletedAt" IS NULL AND "uom_type" = 'reference';--> statement-breakpoint
CREATE UNIQUE INDEX "uq_reference_uom_categories_name" ON "reference"."uom_categories" (lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_commission_plans_name" ON "sales"."commission_plans" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_consignment_agreement_lines_unique" ON "sales"."consignment_agreement_lines" ("tenant_id","agreement_id","product_id") WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_consignment_agreements_name" ON "sales"."consignment_agreements" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_consignment_stock_reports_date" ON "sales"."consignment_stock_reports" ("tenant_id","agreement_id","report_date") WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_fiscal_positions_name" ON "sales"."fiscal_positions" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_partner_addresses_default_type" ON "sales"."partner_addresses" ("tenant_id","partner_id","type") WHERE "deletedAt" IS NULL AND "is_default" = true;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_partner_bank_accounts_acc_number" ON "sales"."partner_bank_accounts" ("tenant_id",lower("acc_number")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_partner_bank_accounts_default" ON "sales"."partner_bank_accounts" ("tenant_id","partner_id") WHERE "deletedAt" IS NULL AND "is_default" = true;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_partner_tags_name" ON "sales"."partner_tags" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_partners_email" ON "sales"."partners" ("tenant_id",lower("email")) WHERE "deletedAt" IS NULL AND "email" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_payment_terms_name" ON "sales"."payment_terms" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_pricelists_name" ON "sales"."pricelists" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_product_attribute_values_name" ON "sales"."product_attribute_values" ("tenant_id","attribute_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_sales_product_attributes_tenant" ON "sales"."product_attributes" ("tenant_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_product_attributes_name" ON "sales"."product_attributes" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_product_categories_name" ON "sales"."product_categories" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_product_templates_barcode" ON "sales"."product_templates" ("tenant_id",lower("barcode")) WHERE "deletedAt" IS NULL AND "barcode" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_product_variants_barcode" ON "sales"."product_variants" ("tenant_id",lower("barcode")) WHERE "deletedAt" IS NULL AND "barcode" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_product_variants_combination" ON "sales"."product_variants" ("tenant_id","template_id","combination_indices") WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_products_sku" ON "sales"."products" ("tenant_id",lower("sku")) WHERE "deletedAt" IS NULL AND "sku" IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_sales_return_orders_status" ON "sales"."return_orders" ("tenant_id","status","updatedAt");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_return_reason_codes_code" ON "sales"."return_reason_codes" ("tenant_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_return_reason_codes_name" ON "sales"."return_reason_codes" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_rounding_policies_effective" ON "sales"."rounding_policies" ("tenant_id","policy_key","currency_code","effective_from") WHERE "deletedAt" IS NULL AND "is_active" = true;--> statement-breakpoint
...
CREATE INDEX "idx_sales_document_attachments_lookup" ON "sales"."document_attachments" ("tenant_id","document_type","document_id","createdAt");--> statement-breakpoint
CREATE INDEX "idx_sales_document_attachments_type" ON "sales"."document_attachments" ("tenant_id","attachment_type","createdAt");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_document_attachments_storage_path" ON "sales"."document_attachments" ("tenant_id","storage_path") WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_orders_sequence_number" ON "sales"."sales_orders" ("tenant_id","sequence_number") WHERE "deletedAt" IS NULL AND "sequence_number" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_sales_team_members_unique" ON "sales"."sales_team_members" ("tenant_id","team_id","user_id") WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_sales_teams_code" ON "sales"."sales_teams" ("tenant_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_sales_teams_name" ON "sales"."sales_teams" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_subscription_close_reasons_code" ON "sales"."subscription_close_reasons" ("tenant_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_subscription_close_reasons_name" ON "sales"."subscription_close_reasons" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_subscription_templates_name" ON "sales"."subscription_templates" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_subscriptions_name" ON "sales"."subscriptions" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_tax_groups_name" ON "sales"."tax_groups" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_tax_rates_name" ON "sales"."tax_rates" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_sales_territories_code" ON "sales"."territories" ("tenant_id",lower("code")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_sales_territories_name" ON "sales"."territories" ("tenant_id",lower("name")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
...
ALTER TABLE "reference"."approval_logs" ADD CONSTRAINT "fk_reference_approval_logs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "reference"."document_attachments" ADD CONSTRAINT "fk_reference_document_attachments_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "reference"."sequences" ADD CONSTRAINT "fk_reference_sequences_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "security"."users" ADD CONSTRAINT "fk_users_tenant" FOREIGN KEY ("tenantId") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."accounting_postings" ADD CONSTRAINT "fk_sales_accounting_postings_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."commission_entries" ADD CONSTRAINT "fk_sales_commission_entries_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."commission_plan_tiers" ADD CONSTRAINT "fk_sales_commission_plan_tiers_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."commission_plans" ADD CONSTRAINT "fk_sales_commission_plans_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."consignment_agreement_lines" ADD CONSTRAINT "fk_sales_consignment_agreement_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."consignment_agreements" ADD CONSTRAINT "fk_sales_consignment_agreements_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."consignment_stock_report_lines" ADD CONSTRAINT "fk_sales_consignment_stock_report_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."consignment_stock_reports" ADD CONSTRAINT "fk_sales_consignment_stock_reports_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."document_approvals" ADD CONSTRAINT "fk_sales_document_approvals_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."document_status_history" ADD CONSTRAINT "fk_sales_document_status_history_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."domain_event_logs" ADD CONSTRAINT "fk_sales_domain_event_logs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."domain_invariant_logs" ADD CONSTRAINT "fk_sales_domain_invariant_logs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."fiscal_position_account_maps" ADD CONSTRAINT "fk_sales_fiscal_position_account_maps_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."fiscal_position_tax_maps" ADD CONSTRAINT "fk_sales_fiscal_position_tax_maps_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."fiscal_positions" ADD CONSTRAINT "fk_sales_fiscal_positions_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."line_item_discounts" ADD CONSTRAINT "fk_sales_line_item_discounts_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."partner_addresses" ADD CONSTRAINT "fk_sales_partner_addresses_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."partner_bank_accounts" ADD CONSTRAINT "fk_sales_partner_bank_accounts_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."partner_tag_assignments" ADD CONSTRAINT "fk_sales_partner_tag_assignments_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."partner_tags" ADD CONSTRAINT "fk_sales_partner_tags_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."partners" ADD CONSTRAINT "fk_sales_partners_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."payment_term_lines" ADD CONSTRAINT "fk_sales_payment_term_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."payment_terms" ADD CONSTRAINT "fk_sales_payment_terms_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."pricelist_items" ADD CONSTRAINT "fk_sales_pricelist_items_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."pricelists" ADD CONSTRAINT "fk_sales_pricelists_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_attribute_values" ADD CONSTRAINT "fk_sales_product_attribute_values_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_attributes" ADD CONSTRAINT "fk_sales_product_attributes_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."product_categories" ADD CONSTRAINT "fk_sales_product_categories_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_packaging" ADD CONSTRAINT "fk_sales_product_packaging_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_template_attribute_lines" ADD CONSTRAINT "fk_sales_ptmpl_attr_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_template_attribute_values" ADD CONSTRAINT "fk_sales_ptmpl_attr_vals_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_templates" ADD CONSTRAINT "fk_sales_product_templates_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."product_variants" ADD CONSTRAINT "fk_sales_product_variants_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."products" ADD CONSTRAINT "fk_sales_products_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."return_order_lines" ADD CONSTRAINT "fk_sales_return_order_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."return_orders" ADD CONSTRAINT "fk_sales_return_orders_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."return_reason_codes" ADD CONSTRAINT "fk_sales_return_reason_codes_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."rounding_policies" ADD CONSTRAINT "fk_sales_rounding_policies_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."sale_order_line_taxes" ADD CONSTRAINT "fk_sales_sale_order_line_taxes_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sale_order_option_lines" ADD CONSTRAINT "fk_sales_sale_order_option_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sale_order_status_history" ADD CONSTRAINT "fk_sales_sale_order_status_history_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sale_order_tax_summary" ADD CONSTRAINT "fk_sales_sale_order_tax_summary_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."document_attachments" ADD CONSTRAINT "fk_sales_document_attachments_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."sales_order_lines" ADD CONSTRAINT "fk_sales_order_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sales_orders" ADD CONSTRAINT "fk_sales_orders_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sales_team_members" ADD CONSTRAINT "fk_sales_sales_team_members_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."sales_teams" ADD CONSTRAINT "fk_sales_sales_teams_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."subscription_close_reasons" ADD CONSTRAINT "fk_sales_subscription_close_reasons_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "sales"."subscription_lines" ADD CONSTRAINT "fk_sales_subscription_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."subscription_logs" ADD CONSTRAINT "fk_sales_subscription_logs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."subscription_templates" ADD CONSTRAINT "fk_sales_subscription_templates_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."subscriptions" ADD CONSTRAINT "fk_sales_subscriptions_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."tax_groups" ADD CONSTRAINT "fk_sales_tax_groups_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."tax_rate_children" ADD CONSTRAINT "fk_sales_tax_rate_children_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."tax_rates" ADD CONSTRAINT "fk_sales_tax_rates_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."territories" ADD CONSTRAINT "fk_sales_territories_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "sales"."territory_rules" ADD CONSTRAINT "fk_sales_territory_rules_tenant" FOREIGN KEY ("tenant_id") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
CREATE POLICY "reference_approval_logs_tenant_select" ON "reference"."approval_logs" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_approval_logs_tenant_insert" ON "reference"."approval_logs" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_approval_logs_tenant_update" ON "reference"."approval_logs" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_approval_logs_tenant_delete" ON "reference"."approval_logs" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "reference_document_attachments_tenant_select" ON "reference"."document_attachments" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_document_attachments_tenant_insert" ON "reference"."document_attachments" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_document_attachments_tenant_update" ON "reference"."document_attachments" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_document_attachments_tenant_delete" ON "reference"."document_attachments" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "reference_sequences_tenant_select" ON "reference"."sequences" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_sequences_tenant_insert" ON "reference"."sequences" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_sequences_tenant_update" ON "reference"."sequences" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "reference_sequences_tenant_delete" ON "reference"."sequences" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "users_tenant_select" ON "security"."users" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "users_tenant_insert" ON "security"."users" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "users_tenant_update" ON "security"."users" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "users_tenant_delete" ON "security"."users" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_accounting_postings_tenant_select" ON "sales"."accounting_postings" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_accounting_postings_tenant_insert" ON "sales"."accounting_postings" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_accounting_postings_tenant_update" ON "sales"."accounting_postings" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_accounting_postings_tenant_delete" ON "sales"."accounting_postings" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_commission_entries_tenant_select" ON "sales"."commission_entries" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_entries_tenant_insert" ON "sales"."commission_entries" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_entries_tenant_update" ON "sales"."commission_entries" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_entries_tenant_delete" ON "sales"."commission_entries" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_commission_plan_tiers_tenant_select" ON "sales"."commission_plan_tiers" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plan_tiers_tenant_insert" ON "sales"."commission_plan_tiers" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plan_tiers_tenant_update" ON "sales"."commission_plan_tiers" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plan_tiers_tenant_delete" ON "sales"."commission_plan_tiers" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_commission_plans_tenant_select" ON "sales"."commission_plans" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plans_tenant_insert" ON "sales"."commission_plans" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plans_tenant_update" ON "sales"."commission_plans" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_commission_plans_tenant_delete" ON "sales"."commission_plans" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_consignment_agreement_lines_tenant_select" ON "sales"."consignment_agreement_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreement_lines_tenant_insert" ON "sales"."consignment_agreement_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreement_lines_tenant_update" ON "sales"."consignment_agreement_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreement_lines_tenant_delete" ON "sales"."consignment_agreement_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_consignment_agreements_tenant_select" ON "sales"."consignment_agreements" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreements_tenant_insert" ON "sales"."consignment_agreements" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreements_tenant_update" ON "sales"."consignment_agreements" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_agreements_tenant_delete" ON "sales"."consignment_agreements" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_consignment_stock_report_lines_tenant_select" ON "sales"."consignment_stock_report_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_report_lines_tenant_insert" ON "sales"."consignment_stock_report_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_report_lines_tenant_update" ON "sales"."consignment_stock_report_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_report_lines_tenant_delete" ON "sales"."consignment_stock_report_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_consignment_stock_reports_tenant_select" ON "sales"."consignment_stock_reports" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_reports_tenant_insert" ON "sales"."consignment_stock_reports" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_reports_tenant_update" ON "sales"."consignment_stock_reports" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_consignment_stock_reports_tenant_delete" ON "sales"."consignment_stock_reports" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_document_approvals_tenant_select" ON "sales"."document_approvals" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_approvals_tenant_insert" ON "sales"."document_approvals" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_approvals_tenant_update" ON "sales"."document_approvals" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_approvals_tenant_delete" ON "sales"."document_approvals" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_document_status_history_tenant_select" ON "sales"."document_status_history" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_status_history_tenant_insert" ON "sales"."document_status_history" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_status_history_tenant_update" ON "sales"."document_status_history" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_status_history_tenant_delete" ON "sales"."document_status_history" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_domain_event_logs_tenant_select" ON "sales"."domain_event_logs" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_event_logs_tenant_insert" ON "sales"."domain_event_logs" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_event_logs_tenant_update" ON "sales"."domain_event_logs" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_event_logs_tenant_delete" ON "sales"."domain_event_logs" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_domain_invariant_logs_tenant_select" ON "sales"."domain_invariant_logs" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_invariant_logs_tenant_insert" ON "sales"."domain_invariant_logs" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_invariant_logs_tenant_update" ON "sales"."domain_invariant_logs" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_domain_invariant_logs_tenant_delete" ON "sales"."domain_invariant_logs" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_fiscal_position_account_maps_tenant_select" ON "sales"."fiscal_position_account_maps" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_account_maps_tenant_insert" ON "sales"."fiscal_position_account_maps" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_account_maps_tenant_update" ON "sales"."fiscal_position_account_maps" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_account_maps_tenant_delete" ON "sales"."fiscal_position_account_maps" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_fiscal_position_tax_maps_tenant_select" ON "sales"."fiscal_position_tax_maps" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_tax_maps_tenant_insert" ON "sales"."fiscal_position_tax_maps" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_tax_maps_tenant_update" ON "sales"."fiscal_position_tax_maps" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_position_tax_maps_tenant_delete" ON "sales"."fiscal_position_tax_maps" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_fiscal_positions_tenant_select" ON "sales"."fiscal_positions" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_positions_tenant_insert" ON "sales"."fiscal_positions" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_positions_tenant_update" ON "sales"."fiscal_positions" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_fiscal_positions_tenant_delete" ON "sales"."fiscal_positions" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_line_item_discounts_tenant_select" ON "sales"."line_item_discounts" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_line_item_discounts_tenant_insert" ON "sales"."line_item_discounts" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_line_item_discounts_tenant_update" ON "sales"."line_item_discounts" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_line_item_discounts_tenant_delete" ON "sales"."line_item_discounts" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_partner_addresses_tenant_select" ON "sales"."partner_addresses" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_addresses_tenant_insert" ON "sales"."partner_addresses" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_addresses_tenant_update" ON "sales"."partner_addresses" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_addresses_tenant_delete" ON "sales"."partner_addresses" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_partner_bank_accounts_tenant_select" ON "sales"."partner_bank_accounts" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_bank_accounts_tenant_insert" ON "sales"."partner_bank_accounts" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_bank_accounts_tenant_update" ON "sales"."partner_bank_accounts" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_bank_accounts_tenant_delete" ON "sales"."partner_bank_accounts" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_partner_tag_assignments_tenant_select" ON "sales"."partner_tag_assignments" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tag_assignments_tenant_insert" ON "sales"."partner_tag_assignments" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tag_assignments_tenant_update" ON "sales"."partner_tag_assignments" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tag_assignments_tenant_delete" ON "sales"."partner_tag_assignments" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_partner_tags_tenant_select" ON "sales"."partner_tags" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tags_tenant_insert" ON "sales"."partner_tags" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tags_tenant_update" ON "sales"."partner_tags" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partner_tags_tenant_delete" ON "sales"."partner_tags" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_partners_tenant_select" ON "sales"."partners" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partners_tenant_insert" ON "sales"."partners" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partners_tenant_update" ON "sales"."partners" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_partners_tenant_delete" ON "sales"."partners" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_payment_term_lines_tenant_select" ON "sales"."payment_term_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_term_lines_tenant_insert" ON "sales"."payment_term_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_term_lines_tenant_update" ON "sales"."payment_term_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_term_lines_tenant_delete" ON "sales"."payment_term_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_payment_terms_tenant_select" ON "sales"."payment_terms" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_terms_tenant_insert" ON "sales"."payment_terms" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_terms_tenant_update" ON "sales"."payment_terms" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_payment_terms_tenant_delete" ON "sales"."payment_terms" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_pricelist_items_tenant_select" ON "sales"."pricelist_items" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelist_items_tenant_insert" ON "sales"."pricelist_items" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelist_items_tenant_update" ON "sales"."pricelist_items" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelist_items_tenant_delete" ON "sales"."pricelist_items" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_pricelists_tenant_select" ON "sales"."pricelists" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelists_tenant_insert" ON "sales"."pricelists" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelists_tenant_update" ON "sales"."pricelists" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_pricelists_tenant_delete" ON "sales"."pricelists" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_attribute_values_tenant_select" ON "sales"."product_attribute_values" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attribute_values_tenant_insert" ON "sales"."product_attribute_values" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attribute_values_tenant_update" ON "sales"."product_attribute_values" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attribute_values_tenant_delete" ON "sales"."product_attribute_values" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_attributes_tenant_select" ON "sales"."product_attributes" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attributes_tenant_insert" ON "sales"."product_attributes" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attributes_tenant_update" ON "sales"."product_attributes" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_attributes_tenant_delete" ON "sales"."product_attributes" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_categories_tenant_select" ON "sales"."product_categories" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_categories_tenant_insert" ON "sales"."product_categories" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_categories_tenant_update" ON "sales"."product_categories" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_categories_tenant_delete" ON "sales"."product_categories" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_packaging_tenant_select" ON "sales"."product_packaging" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_packaging_tenant_insert" ON "sales"."product_packaging" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_packaging_tenant_update" ON "sales"."product_packaging" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_packaging_tenant_delete" ON "sales"."product_packaging" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_template_attribute_lines_tenant_select" ON "sales"."product_template_attribute_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_lines_tenant_insert" ON "sales"."product_template_attribute_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_lines_tenant_update" ON "sales"."product_template_attribute_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_lines_tenant_delete" ON "sales"."product_template_attribute_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_template_attribute_values_tenant_select" ON "sales"."product_template_attribute_values" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_values_tenant_insert" ON "sales"."product_template_attribute_values" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_values_tenant_update" ON "sales"."product_template_attribute_values" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_template_attribute_values_tenant_delete" ON "sales"."product_template_attribute_values" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_templates_tenant_select" ON "sales"."product_templates" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_templates_tenant_insert" ON "sales"."product_templates" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_templates_tenant_update" ON "sales"."product_templates" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_templates_tenant_delete" ON "sales"."product_templates" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_product_variants_tenant_select" ON "sales"."product_variants" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_variants_tenant_insert" ON "sales"."product_variants" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_variants_tenant_update" ON "sales"."product_variants" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_product_variants_tenant_delete" ON "sales"."product_variants" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_products_tenant_select" ON "sales"."products" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_products_tenant_insert" ON "sales"."products" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_products_tenant_update" ON "sales"."products" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_products_tenant_delete" ON "sales"."products" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_return_order_lines_tenant_select" ON "sales"."return_order_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_order_lines_tenant_insert" ON "sales"."return_order_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_order_lines_tenant_update" ON "sales"."return_order_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_order_lines_tenant_delete" ON "sales"."return_order_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_return_orders_tenant_select" ON "sales"."return_orders" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_orders_tenant_insert" ON "sales"."return_orders" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_orders_tenant_update" ON "sales"."return_orders" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_orders_tenant_delete" ON "sales"."return_orders" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_return_reason_codes_tenant_select" ON "sales"."return_reason_codes" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_reason_codes_tenant_insert" ON "sales"."return_reason_codes" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_reason_codes_tenant_update" ON "sales"."return_reason_codes" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_return_reason_codes_tenant_delete" ON "sales"."return_reason_codes" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_rounding_policies_tenant_select" ON "sales"."rounding_policies" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_rounding_policies_tenant_insert" ON "sales"."rounding_policies" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_rounding_policies_tenant_update" ON "sales"."rounding_policies" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_rounding_policies_tenant_delete" ON "sales"."rounding_policies" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sale_order_line_taxes_tenant_select" ON "sales"."sale_order_line_taxes" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_line_taxes_tenant_insert" ON "sales"."sale_order_line_taxes" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_line_taxes_tenant_update" ON "sales"."sale_order_line_taxes" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_line_taxes_tenant_delete" ON "sales"."sale_order_line_taxes" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sale_order_option_lines_tenant_select" ON "sales"."sale_order_option_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_option_lines_tenant_insert" ON "sales"."sale_order_option_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_option_lines_tenant_update" ON "sales"."sale_order_option_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_option_lines_tenant_delete" ON "sales"."sale_order_option_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sale_order_status_history_tenant_select" ON "sales"."sale_order_status_history" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_status_history_tenant_insert" ON "sales"."sale_order_status_history" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_status_history_tenant_update" ON "sales"."sale_order_status_history" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_status_history_tenant_delete" ON "sales"."sale_order_status_history" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sale_order_tax_summary_tenant_select" ON "sales"."sale_order_tax_summary" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_tax_summary_tenant_insert" ON "sales"."sale_order_tax_summary" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_tax_summary_tenant_update" ON "sales"."sale_order_tax_summary" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sale_order_tax_summary_tenant_delete" ON "sales"."sale_order_tax_summary" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_document_attachments_tenant_select" ON "sales"."document_attachments" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_attachments_tenant_insert" ON "sales"."document_attachments" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_attachments_tenant_update" ON "sales"."document_attachments" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_document_attachments_tenant_delete" ON "sales"."document_attachments" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_order_lines_tenant_select" ON "sales"."sales_order_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_order_lines_tenant_insert" ON "sales"."sales_order_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_order_lines_tenant_update" ON "sales"."sales_order_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_order_lines_tenant_delete" ON "sales"."sales_order_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_orders_tenant_select" ON "sales"."sales_orders" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_orders_tenant_insert" ON "sales"."sales_orders" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_orders_tenant_update" ON "sales"."sales_orders" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_orders_tenant_delete" ON "sales"."sales_orders" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sales_team_members_tenant_select" ON "sales"."sales_team_members" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_team_members_tenant_insert" ON "sales"."sales_team_members" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_team_members_tenant_update" ON "sales"."sales_team_members" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_team_members_tenant_delete" ON "sales"."sales_team_members" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_sales_teams_tenant_select" ON "sales"."sales_teams" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_teams_tenant_insert" ON "sales"."sales_teams" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_teams_tenant_update" ON "sales"."sales_teams" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_sales_teams_tenant_delete" ON "sales"."sales_teams" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_subscription_close_reasons_tenant_select" ON "sales"."subscription_close_reasons" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_close_reasons_tenant_insert" ON "sales"."subscription_close_reasons" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_close_reasons_tenant_update" ON "sales"."subscription_close_reasons" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_close_reasons_tenant_delete" ON "sales"."subscription_close_reasons" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_subscription_lines_tenant_select" ON "sales"."subscription_lines" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_lines_tenant_insert" ON "sales"."subscription_lines" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_lines_tenant_update" ON "sales"."subscription_lines" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_lines_tenant_delete" ON "sales"."subscription_lines" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_subscription_logs_tenant_select" ON "sales"."subscription_logs" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_logs_tenant_insert" ON "sales"."subscription_logs" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_logs_tenant_update" ON "sales"."subscription_logs" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_logs_tenant_delete" ON "sales"."subscription_logs" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_subscription_templates_tenant_select" ON "sales"."subscription_templates" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_templates_tenant_insert" ON "sales"."subscription_templates" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_templates_tenant_update" ON "sales"."subscription_templates" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscription_templates_tenant_delete" ON "sales"."subscription_templates" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_subscriptions_tenant_select" ON "sales"."subscriptions" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscriptions_tenant_insert" ON "sales"."subscriptions" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscriptions_tenant_update" ON "sales"."subscriptions" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_subscriptions_tenant_delete" ON "sales"."subscriptions" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_tax_groups_tenant_select" ON "sales"."tax_groups" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_groups_tenant_insert" ON "sales"."tax_groups" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_groups_tenant_update" ON "sales"."tax_groups" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_groups_tenant_delete" ON "sales"."tax_groups" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_tax_rate_children_tenant_select" ON "sales"."tax_rate_children" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rate_children_tenant_insert" ON "sales"."tax_rate_children" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rate_children_tenant_update" ON "sales"."tax_rate_children" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rate_children_tenant_delete" ON "sales"."tax_rate_children" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_tax_rates_tenant_select" ON "sales"."tax_rates" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rates_tenant_insert" ON "sales"."tax_rates" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rates_tenant_update" ON "sales"."tax_rates" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_tax_rates_tenant_delete" ON "sales"."tax_rates" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_territories_tenant_select" ON "sales"."territories" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territories_tenant_insert" ON "sales"."territories" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territories_tenant_update" ON "sales"."territories" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territories_tenant_delete" ON "sales"."territories" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
...
CREATE POLICY "sales_territory_rules_tenant_select" ON "sales"."territory_rules" AS PERMISSIVE FOR SELECT TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territory_rules_tenant_insert" ON "sales"."territory_rules" AS PERMISSIVE FOR INSERT TO "app_user" WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territory_rules_tenant_update" ON "sales"."territory_rules" AS PERMISSIVE FOR UPDATE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int) WITH CHECK ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint
CREATE POLICY "sales_territory_rules_tenant_delete" ON "sales"."territory_rules" AS PERMISSIVE FOR DELETE TO "app_user" USING ("tenantId" = NULLIF(current_setting('afenda.tenant_id', true), '')::int);--> statement-breakpoint

/**
 * Resolution caching primitives shared across packages.
 *
 * The cache is intentionally environment-neutral so it can live in meta-types
 * without depending on Node globals or browser timers.
 */

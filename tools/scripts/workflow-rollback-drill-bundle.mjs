...
const context = resolveNonSalesGovernanceContext({ root: ROOT, args: [...args], aggregate: "workflow" });
...
const bundle = [
  ...
  {
    title: "Workflow replay concurrency validation",
    command: "pnpm",
...
const lines = [];
lines.push("# Workflow Rollback Drill Evidence");
lines.push("");
lines.push(`- Generated at (UTC): ${finishedAt}`);
lines.push("- Aggregate: workflow");
